...
SuperAdminCreateOrganizationPostModel superAdminCreateOrganizationPostModelFromJson(String str) => SuperAdminCreateOrganizationPostModel.fromJson(json.decode(str));
String superAdminCreateOrganizationPostModelToJson(SuperAdminCreateOrganizationPostModel data) => json.encode(data.toJson());
class SuperAdminCreateOrganizationPostModel {
  ...
  String? _message;
  String? _stack;
SuperAdminCreateOrganizationPostModel copyWith({  num? code,
  String? message,
  String? stack,
}) => SuperAdminCreateOrganizationPostModel(  code: code ?? _code,
