...
SuperAdminOrganizationGetModel superAdminOrganizationGetModelFromJson(String str) => SuperAdminOrganizationGetModel.fromJson(json.decode(str));
String superAdminOrganizationGetModelToJson(SuperAdminOrganizationGetModel data) => json.encode(data.toJson());
class SuperAdminOrganizationGetModel {
  ...
  String? _message;
  String? _stack;
SuperAdminOrganizationGetModel copyWith({  num? code,
  String? message,
  String? stack,
}) => SuperAdminOrganizationGetModel(  code: code ?? _code,
